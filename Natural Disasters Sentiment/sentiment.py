...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 19 21:34:34 2020
...
NEGATE = \
    ["aint", "arent", "cannot", "cant", "couldnt", "darent", "didnt", "doesnt",
     ...
     "without", "wont", "wouldnt", "won't", "wouldn't", "rarely", "seldom", "despite", "trash"]
...
BOOSTER_DICT = \
    {"absolutely": B_INCR, "amazingly": B_INCR, "awfully": B_INCR, 
     ...
     "sort of": B_DECR, "sorta": B_DECR, "sortof": B_DECR, "sort-of": B_DECR, "trash": B_DECR}
...
SPECIAL_CASES = {"the shit": 3, "the bomb": 3, "bad ass": 1.5, "badass": 1.5, "bus stop": 0.0,
                 "yeah right": -2, "kiss of death": -1.5, "to die for": 3, "beating heart": 3.5, "trash": -1}
...
if __name__ == '__main__':
    ...
    def sent():
        df = read_file("naturaldisasters.csv")
        sent = text(df)
        return sent
    ...
    df.to_csv("naturaldisasters_sentiment.csv", index = False, encoding='utf-8-sig')
